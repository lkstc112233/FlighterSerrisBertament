...
static const int COLORS_ARRAY[] = {
    ...
    0x556B2F, 0xFF8C00, 0x9932CC, 0x8B0000, 0xE9967A, 0x8FBC8F, 0x483D8B,
    ...
    0xADD8E6, 0xF08080, 0xE0FFFF, 0xFAFAD2, 0x90EE90, 0xD3D3D3, 0xFFB6C1,
...
D2D1::ColorF::Enum getRandomColor() {
  static std::default_random_engine colorPicker;
  static std::uniform_int_distribution<int> distribution(
      0, sizeof(COLORS_ARRAY) / sizeof(int) - 1);
  return D2D1::ColorF::Enum(COLORS_ARRAY[distribution(colorPicker)]);
}
